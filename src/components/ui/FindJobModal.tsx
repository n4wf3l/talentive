...
import FindJobForm from '../forms/FindJobForm';
...
export default function FindJobModal({ isOpen, onClose }: FindJobModalProps) {
          ...
          <div className="relative px-6 pt-6 pb-4 sm:px-8 sm:pt-7 shrink-0 border-b border-gray-100">
            ...
            <div className="flex items-center gap-4 pr-12">
              ...
              <div className="min-w-0">
                <h2 className="text-lg font-bold text-primary-800 sm:text-xl">{t('findJob.title')}</h2>
                <p className="mt-0.5 text-xs text-gray-500 sm:text-sm">{t('findJob.subtitle')}</p>
              </div>
            </div>
          </div>
